...
"Copyright &copy; 2023-2024 The Litecoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Mopscoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Mopscoin</b> version", Q_NULLPTR));
