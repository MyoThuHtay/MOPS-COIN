...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Mopscoin - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "Mopscoin Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Mopscoin debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Mopscoin-Qt help message to get a list with possible Mopscoin command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
