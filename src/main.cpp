...
uint256 hashGenesisBlock("0xe9d5ffe1724314c0f939413d9f3e02ea654ecd9fbb9a0b4317fb4914841f3fea");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 5000000 blocks
    nSubsidy >>= (nHeight / 5000000); // Mopscoin: 5000k blocks

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2.5 * 24 * 60 * 60; // Mopscoin: 2.5 days
static const int64 nTargetSpacing = 0.25 * 60; // Mopscoin: 15 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf3a9702c3b374b0e28c5d5bd9980bbbee74158c057326f57d13aee6a9d72ab84");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1692182298;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2090284832;

        if (fTestNet)
        {
            block.nTime    = 1692182316;
            block.nNonce   = 385842358;
        }
...
if (true
 && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x3e6b955c253947f91878fb5ff58e46191e4caffcf8c6b6c72631093342c9762a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc2, 0xb3, 0xdd}; 
