...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mopscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mopschain.site", "mainnet-seed1.mopschain.site"},
    {"mopschain.site", "mainnet-seed2.mopschain.site"},
    {"mopschain.site", "mainnet-seed3.mopschain.site"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"mopschain.site", "testnet.mopschain.site"},
...
unsigned int pnSeed[] =
{
    0xf495bdce,0x7ffcff36,0x857669ac,0x0a001f7f,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mopscoin is probably already running."), addrBind.ToString().c_str());
        else
